    ...
    <main className="mx-auto max-w-6xl px-4 py-12 space-y-16">
      ...
      >
        ...
        <motion.div variants={fadeInUp} className="grid gap-6 lg:grid-cols-3">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-teal-600">Global Partnership</CardTitle>
            </CardHeader>
            <CardContent>
      ...
      >
        ...
        <motion.div variants={fadeInUp} className="grid gap-6 md:grid-cols-2">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-teal-600">⚡ Prompt Delivery</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-teal-600">👥 Great Team</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-teal-600">💯 100% Satisfaction</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-teal-600">💰 Affordable Cost</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-teal-600">🏆 High Success Rates</CardTitle>
            </CardHeader>
            <CardContent>
