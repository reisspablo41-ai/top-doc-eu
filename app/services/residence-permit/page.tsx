    ...
    <main className="mx-auto max-w-6xl px-4 py-12 space-y-16">
      ...
      >
        ...
        <div className="text-lg md:text-xl text-zinc-700 max-w-3xl mx-auto leading-relaxed space-y-4">
          <p>
            Topo Docs Wu is a trusted provider of high-quality residence permit documents, created with attention to detail and precision. We specialize in delivering residence permits that meet expected standards, ensuring accuracy, consistency, and a professional finish.
          </p>
          <p>
          ...
          <CardContent className="pt-6 space-y-6">
            <div>
              ...
              <p className="text-lg text-zinc-700 leading-relaxed mb-4">
                Topo Docs Wu provides professionally crafted residence permit documents designed with a strong emphasis on precision, structure, and advanced security presentation. Each document is produced to reflect the complexity and refinement expected of modern international residence permits.
              </p>
              <p className="text-lg text-zinc-700 leading-relaxed mb-4">
